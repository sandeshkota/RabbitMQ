...
namespace Client
{
    class RabbitSender
    {
        ...
        private const string _exchangeName = "CashAccount.HoldingExchange";
        ...
        public void Send(string message, string expirationTime)
        {
            var properties = _model.CreateBasicProperties();
            properties.Persistent = true;
            properties.Expiration = expirationTime; // In milliseconds
