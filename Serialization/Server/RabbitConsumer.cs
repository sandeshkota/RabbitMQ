    ...
    public class RabbitConsumer
    {
        ...
        public void Start()
        {
            ...
            while (Enabled)
            {
                ...
                var messageObj = Newtonsoft.Json.JsonConvert.DeserializeObject<Message>(jsonString);

                Console.WriteLine($"Message Received: JSON = {jsonString}");
                Console.WriteLine($"Message Received: Message = {messageObj.MyMessage}");
