...
namespace FailureServer
{
    public class FailureConsumer
    {
        ...
        private const string _exchangeName = "CashAccount.RoutingFailureExchange";
        private const string _queueName = "CashAccount.RoutingFailureQueue";
        ...
        public void Start()
        {
            ...
            while (Enabled)
            {
                ...
                Console.WriteLine($"{_queueName} : Message Received: {message}");
